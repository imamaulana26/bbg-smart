...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2019 at 11:06 AM
...
CREATE TABLE `tbl_notaris` (
  `no_app` varchar(100) NOT NULL,
  `nm_key_person` text NOT NULL,
  `gender` text NOT NULL,
  `tgl_lahir_notaris` text NOT NULL,
  `jbtn_notaris` text NOT NULL,
  `sts_notaris` text NOT NULL,
  `pend_notaris` text NOT NULL,
  `npwp_notaris` text NOT NULL,
  `nom_saham` text NOT NULL,
  `saham` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_notaris`
--

INSERT INTO `tbl_notaris` (`no_app`, `nm_key_person`, `gender`, `tgl_lahir_notaris`, `jbtn_notaris`, `sts_notaris`, `pend_notaris`, `npwp_notaris`, `nom_saham`, `saham`) VALUES
('1905271321825217', 'Ir Sri Budihardjo Herman::Ir Sri Sudjatmoko Hermawan::Haji Sukida Bin Haji Sana Dohana', 'L::L::L', '1973-06-09::1976-08-09::1974-01-20', 'Dirut/Presdir Pemilik::Direktur Pemilik::Komit/PresKom Pemilik', 'Menikah::Menikah::Menikah', 'S1::S1::S1', '071712913437000::071712913437000::071712913437000', '30000000::30000000::40000000', '30::30::40');
...
('078273241', 'TOHANI', 'tohani@syariahmandiri.co.id', 'ID0010002', 'default.jpg', 'aa134d9ad2fd2f677ea05c7e63323e9e', 3, 0, '2019-05-02 10:37:13', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('1', 'Imam Maulana Ibrahim', 'admin@syariahmandiri.co.id', 'ID0010002', 'default.jpg', '202cb962ac59075b964b07152d234b70', 1, 0, '2019-04-09 00:00:00', '2019-05-27 10:19:53', '2019-05-27 10:21:08'),
('129012405', 'FATMA SRI SANTRINI', 'fssantrini@syariahmandiri.co.id', 'ID0010002', 'default.jpg', 'aa134d9ad2fd2f677ea05c7e63323e9e', 2, 0, '2019-05-02 10:24:09', '2019-05-27 12:57:21', '2019-05-27 09:46:42');
...
--
-- Indexes for table `tbl_notaris`
--
ALTER TABLE `tbl_notaris`
  ADD PRIMARY KEY (`no_app`);
